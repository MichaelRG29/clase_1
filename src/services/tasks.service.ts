...
data.projectId } });
  ...
  if (project.ownerId !== requesterId)
   throw new AppError(403, 'Solo el dueño del proyecto puede crear tareas');
 ...
 requesterId;
  if (!canEdit)
   throw new AppError(403, 'No tienes permiso para modificar esta tarea');
 ...
 where: { id }, include: { project: true },
  ...
  throw new AppError(403, 'Solo el dueño puede eliminar tareas');
